    ...
    <div class="flex-grow-1 width-100">
        <v-slide-x-reverse-transition>
            <div 
                ...
                :class="!!buildSelected ? 'd-flex' : 'd-none'" v-show="!!buildSelected"
            >
                <div class="d-flex flex-row align-center text-uppercase">
                    ...
                    >
                        <span>Above your current level</span>
                    </div>
                </div>

                <hr />

                <div class="fill-height party-overview alt-scrollbar py-2" :class="!!rsd.darkmode ? 'theme--dark' : ''">
                    <div class="d-flex flex-column" v-if="!!$rsd.playercharacters.active">
                        <div class="flex-column width-100 flex-wrap" :class="gameView.build == 0 ? 'd-flex' : 'd-none'">
                        ...
                        <div class="flex-column width-100 flex-wrap" :class="gameView.build != 0 ? 'd-flex' : 'd-none'" v-show="!isInitiated">
                            <v-skeleton-loader
                                v-show="!isInitiated"
                                class="mt-2"
                                max-width="200"
...
import AncestryDialog from './components/AncestryDialog/AncestryDialogMobile'
import AncestryFeatChoiceDialog from './components/AncestryFeatChoiceDialog/AncestryFeatChoiceDialogMobile'
import BackgroundDialog from './components/BackgroundDialog/BackgroundDialogMobile'
import ClassDialog from './components/ClassDialog/ClassDialogMobile'
import ClassFeatChoiceDialog from './components/ClassFeatChoiceDialog/ClassFeatChoiceDialogMobile'
import GeneralFeatChoiceDialog from './components/GeneralFeatChoiceDialog/GeneralFeatChoiceDialogMobile'
import HeritageChoiceDialog from './components/HeritageChoiceDialog/HeritageChoiceDialogMobile'
import SimpleChoiceDialog from './components/SimpleChoiceDialog/SimpleChoiceDialog'
import SkillFeatChoiceDialog from './components/SkillFeatChoiceDialog/SkillFeatChoiceDialogMobile'
