    ...
    methods: {
        ...
        openConditionDialog(type) {
            if (!!type && !!this.selected && !!this.selected.id) {
                ...
                if (!!duration && !!value) {
                    this.$rsd.dialog.open({name: 'addConditionBothDialog', attrs: [false, {type: type, duration:0, value:1, floor: false, reduce: false, affected: [this.selected]}, immune]})
                } else if (!!duration) {
                    this.$rsd.dialog.open({name: 'addConditionDurationDialog', attrs: [false, {type: type, duration:0, affected: [this.selected]}, immune]})
                } else if (!!value) {
                    this.$rsd.dialog.open({name: 'addConditionValueDialog', attrs: [false, {type: type, value:1, floor: false, reduce: false, affected: [this.selected]}, immune]})
                } else {
