...
class CombatMenu extends MobileActionMenu {
    constructor() {
        super()
    }
    ...
    getDailMenu() {
        return {
            ...
            buttons: [
                ...
                {icon: 'mdi-sort', function: () => { this.doChangeInitiative() }},
    ...
    doChangeHealth() {
        ...
        if (!!currentItem && !!currentItem.id) {
            this.$rsd.dialog.open({name: 'combatantHealthDialog', attrs: [true, {...currentItem.health, name: currentItem.name, id: currentItem.id}, {maxhp: currentItem.health.maxhp}]})
        }
    }
